...
KNOCKDOWNS = [0x014a, 0x014e, 0x014f, 0x0150, 0x0152, 0x0153, 0x0154, 0x0155, 0x0156, 0x015a, 0x015e, 0x0162, 0x0166, 0x016e, 0x0176, 0x017e, 0x019a, 0x01d3, 0x01e7, 0x01eb, 0x0207, 0x0227, 0x027f]
...
def HitEffectToLaunchType(he, game):
    if (game == Game.SCIV and he == 0x02d1) or (game == Game.SCV and he == 0x2f4):
        return 'THROW'
